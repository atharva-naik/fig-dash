...
(function (global, factory) {
  ...
  var TEMPLATE = '<div class="viewer-container" tabindex="-1" touch-action="none">' + '<div class="viewer-canvas"></div>'+ '<div style="margin-left: auto; margin-right: auto; text-align: center; margin-top: 5px;"><div class="viewer-title"></div></div>' + '<div class="viewer-footer">' + '<div class="viewer-toolbar" {{ SHOW_JS_TOOLBAR }}></div>' + '<div class="viewer-navbar" {{ SHOW_NAVBAR }}>' + '<ul class="viewer-list" role="navigation"></ul>' + '</div>' + '</div>' + '<div class="viewer-tooltip" role="alert" aria-hidden="true"></div>' + '<div class="viewer-button" data-viewer-action="mix" role="button"></div>' + '<div class="viewer-player"></div>' + '</div>';
